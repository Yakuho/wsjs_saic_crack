...
class ListPageExample(_BaseExample):
    ...
    def step2(self, keyword: str, html_args: dict):
        ...
        request_args = {
            ...
            "request:ncs": "",
            "request:queryAuto": "",
            "request:queryExp": f"(sn = {keyword} OR sn = {keyword}A OR sn = {keyword}B OR sn = {keyword}H$ OR sn = {keyword}I OR sn = {keyword}J OR sn = {keyword}K OR sn = {keyword}S)",
            "request:queryMode": "",
            "request:queryType": "",
            ...
            "attribute-node:record_record-number": 1,
